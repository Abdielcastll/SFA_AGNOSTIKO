...
///
/// Si pinResult es un 'Uint8List' vacío, se aplica el proceso de 'bypass' del
/// PIN.
...
Future<void> emvConfirmPinpadEntry(
    PinEntryParameters pinEntryParameters) async {
  await emvTransactionChannel.invokeMethod(
    "confirmPinpadEntry",
    pinEntryParameters.toJson(),
  );
}
...
Future<void> cancelEmvTransaction() async {
  if (Platform.isLinux) {
    await emvTransactionChannel.invokeMethod("cancelEMV");
  }
