...
- newland (Marca Newland con MESDK)
- newland_nsdk (Marca Newland con NSDK)
- newpos (Marca NewPOS)
- pax (Marca PAX con SDK NeptuneLiteAPI y librerías EMV)
- generic (Implementación genérica para móviles Android - se puede emparejar con un MPOS)
