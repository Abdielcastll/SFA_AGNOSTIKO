      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            if (stockText.isNotEmpty)
              const Row(
                ...
                children: [
                  Text(
                    "Stock: ",
                    style: TextStyle(fontSize: 16,fontFamily: 'Poppins-Regular',color:  Color(0xFF5A5D77),),
                  ),
                  Text(
                    "45 en inventario",
                    style: TextStyle(fontSize: 16,fontFamily: 'Poppins-Regular',color:  Color(0xFF5A5D77),),
            ...
            if (genderOptions.isNotEmpty)
              Row(
                ...
                children: [
                  const Text(
                    "Selecciona género:",
                    style: TextStyle(fontFamily: 'Poppins-Regular',color:  Color(0xFF5A5D77),),
                  ),
            ...
            const Center(child: Text('Precio : \$ 50.00',style: TextStyle(fontSize: 25,fontFamily: 'Poppins-Regular',color:  Color(0xFF5A5D77),),))
          ],
        ),
      ),
    );
