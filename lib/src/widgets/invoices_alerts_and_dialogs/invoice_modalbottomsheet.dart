      ...
      return MultiProvider(
        ...
        child: StatefulBuilder(
          builder: (context, setState) {
            ...
            double paidAmount = priceToCurrencySelectedInput(
                remaining, selectedCoin, coinDecimals, coinExchangeRatio);
                                                  ...
                                                  child: Column(
                                                    children: [
                                                                  ...
                                                                  child: ListView
                                                                    ...
                                                                    itemBuilder:
                                                                      ...
                                                                      final date =
                                                                          payment[
                                                                              'fecha'];
                                                                      final unformattedDate = DateTime.parse(date
                                                                          .toDate()
                                                                          .toString());
                                                                      final paymentDate =
                                                                          dateFormatter
                                                      ...
                                                      remaining <= 0
                                                          ...
                                                          : Container(),
                                                      Text(
                                                        '${AppLocalizations.of(context)!.balanceConfirmed}: ${priceFormat(sumOfApprovedPayments).toStringAsFixed(2)}',
                                                        style: TextStyle(
                                                          fontFamily:
                                                              'Poppins-regular',
                                                          color: Colors.green,
                                                                      ...
                                                                      onChanged:
                                                                        ...
                                                                        if (value
                                                                          ...
                                                                          setState(
                                                                            ...
                                                                            if (selectedValueA ==
                                                                                'Efectivo') {
                                                                              change = moneyRecievedForRegisterMoney < paidAmount ? 0 : double.parse((moneyRecievedForRegisterMoney - paidAmount).toStringAsFixed(2));
                                                                            }
                                                                          });
                                                                        } else {
                                                                          setState(
                                                            ...
                                                            ? selectedValueA !=
                                                                ...
                                                                ? Column(
                                                                    children: [
                                                                      ...
                                                                      Text(
                                                                        'Descuento Maestro ($discountPercentage%): ${priceFormatForPaidAmount(discount, selectedCoin).toStringAsFixed(2)}',
                                                                        style:
                                                                            TextStyle(
                                                                          fontFamily:
                                                                              'Poppins-regular',
                                                                      ...
                                                                      Container(
                                                                        ...
                                                                        child:
                                                                            Row(
                                                                          mainAxisAlignment: selectedValueA != 'Efectivo'
